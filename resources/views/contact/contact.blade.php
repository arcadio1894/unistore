        ...
        <div class="container align-center">
            ...
            <div class="row">
                <div class="col-sm-4 col-sm-offset-4">
                    <form id="formContact" class="contact" action="{{route('store.contact')}}" method="post">
                        @csrf
                        <input type="text" name="name" value="" placeholder="Nombre del Cliente" required="" class="form-control" />
                        <br>
...
@endsection
@section('scripts')
    <script src="{{ asset('js/contact/index.js') }}"></script>
@endsection
