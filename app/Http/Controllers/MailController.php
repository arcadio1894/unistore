    ...
    public function storeContact(Request $request)
    {
        ...
        try {
            ...
            $messages = [
                ...
                'name.min' => 'El nombre debe contener minimo 6 caracteres.',
                ...
                'affair.min' => 'El asunto debe contener minimo 4 caracteres.',
                'message.required' => 'El mensaje es obligatorio.',
                'message.string' => 'El mensaje debe contener caracteres válidos.',
                'message.min' => 'El mensaje debe contener minimo 4 caracteres.',
            ];
